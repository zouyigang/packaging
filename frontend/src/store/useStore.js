...
const sampleItems = [
  { id: 'box-A', name: '大箱A', length: 600, width: 400, height: 400, weight: 20, quantity: 8, allowed_rotations: allRotations, stackable: true, stacking_type: 'stackable', max_load_top: null, category: 'A' },
